...
A GitHub Action that evaluates backend implementations against the 42-Challenge specification. Scores 7 trials (95 points) plus a stress-test boss encounter (+10 bonus).
...
4. Posts a score summary as a PR comment (on pull requests)
